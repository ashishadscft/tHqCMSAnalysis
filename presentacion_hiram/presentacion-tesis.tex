...
{\nologo
	...
	\begin{center}
		\begin{tabular}{cc}
			...
			{Distribution of selected events as a function of the jet with largest value of $|\eta|$} & {Distribution of selected events with higher pt with a |$\eta$| < 2.4 } \\
			...
			{Distribution of jet events for $|\eta|$>1 } & {Distribution of events of pt of the sub leading leptons} \\
		\end{tabular}
	\end{center}
\end{frame}
}
...
{Distribution of events of $|\Delta\eta|$ between a forward jet and the closest lepton} & {Distribution of events of $\Delta\phi$ between the higher pt pair of leptons } \\
		...
		{Distribution of events with a $\Delta R$ between the lepton pairs (highest and lowest pt)} & {Distribution of events as function of $|\Delta\eta|$ between a forward jet and a b-tagged jet } \\
	\end{tabular}
\end{center}
\end{frame}
}
