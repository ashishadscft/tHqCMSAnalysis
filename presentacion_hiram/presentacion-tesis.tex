...
\setbeamercolor*{frametitle}{bg=white}
 ...
 \author{\scriptsize
   ...
   Director:\\
   \vspace{1px}
  Dr. Jos\'e Feliciano Ben\'itez Rubio\\
\vspace{5px}
...
\begin{table}
	...
	\end{tabular}
\end{table}
\footnotetext[1]{\tiny{Data taken from The CERN collaboration “Higgs Physics the HL-LHC and HE-LHC” 2019, CERN-LPCC-2018-04}}
\end{frame}
...
%it has the same dimension as mass (or energy).}
\end{frame}
...
\tiny{
	\begin{enumerate}
		\item	$p_t$ of the sub leading leptons
		\item 	Maximum  $|\eta|$ of any  (untagged)  jet (forward jet)
		\item 	Number of jets with high $p_t$ >25 GeV and |$\eta$| < 2.4
		\item	Number of untagged jets with |$\eta$| > 1.0
		\item	$|\Delta\eta|$ between a forward light jet and closest lepton
		\item	$|\Delta\eta|$ between a forward light jet and a b-tagged jet
		\item 	Minimum $\Delta$R between any two leptons
		\item 	$\Delta\phi$ of the highest $p_t$ same-sign lepton pair
...
{\nologo
	\begin{frame}
		...
		\begin{table}
			\centering
			\begin{tabular}{cc}
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-pt-sub} &
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-abs-pj-eta}\\ 
				{} &{}\\
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variablescompare_variables-ncj24}&
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-nfj}\\		
				{} & { } \\
			\end{tabular}
		\end{table}
	\end{frame}
...
{\nologo
	...
	\frametitle{Kinematic variables}
		...
		\begin{center}
			\begin{tabular}{cc}
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-eta-fj-cl} &
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-eta-fj-b1}\\ 
				{} & {	} \\
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-dr}&
				\includegraphics[width=5.5cm,height=3.5cm]{figures/distributions/compare_variables-phi}\\
				{} & {} \\
			\end{tabular}
		\end{center}
	\end{frame}
...
{\nologo
\begin{frame}
	\frametitle{BDT Training Result}
	\begin{figure}[ht]
		\centering
		\includegraphics[scale=0.48]{figures/bdt-8var}
	\end{figure}
\end{frame}}

{\nologo
\begin{frame}
\subsection{Event distributions and yields}
\frametitle{Event distributions and yields}
\begin{minipage}[c]{0.45\textwidth}
\begin{figure}
	\centering
	\includegraphics[scale=0.18]{figures/kos.png}
	\caption*{\tiny{Pre-fit classifier outputs for same sign dimuon }}
\end{figure}
\end{minipage}
\hfill
...
\frametitle{Post-fit Results}
	\begin{table}[ht!]
		...
		\label{table1}
	\end{table}
 Pre-fit uncertainty is statistical only. Post-fit uncertainty is statistical + systematic.
\end{frame}



\begin{frame}
	\subsection{Extrapolation to high luminosity}
...
{\nologo
	\begin{frame}
	\frametitle{Extrapolation to high luminosity for SM }
	\begin{center}
		\begin{tabular}{cc}
...
{\nologo
	\begin{frame}
	\frametitle{Extrapolation to high luminosity for $k_t=-1$ scenario}
	\begin{center}
		\begin{tabular}{cc}
...
{\nologo
	\begin{frame}
	\frametitle{Likelihood scan for $k_t=-1$ scenario}
	\begin{center}
		\begin{tabular}{cc}
