...
\frametitle{Results}
		\begin{figure}
			\begin{minipage}{0.4\textwidth}
				\centering
			\includegraphics[width=5.5cm,height=5cm]{figures/kt-1/kin-kt-1.png}
			\captionof*{figure}{\tiny{Pre-fit signal and background yields for tH process for $k_t$=-1.\\
					In the box below each distribution, the ratio of the observed and predicted event yields is shown}}
\end{minipage}\hfill \quad
\begin{minipage}{0.4\textwidth}
	\centering
			\includegraphics[width=5.5cm,height=5cm]{figures/kt-1/simple-kt-1.png}
			\captionof*{figure}{\tiny{Post-fit signal and background yields for tH process for $k_t$=-1. \\ 
					In the box below each distribution, the ratio of the observed and predicted event yields is shown}}
\end{minipage}
		\end{figure}
\end{frame}
...
\nologo{
\begin{frame}
\frametitle{P Value and significance }
%(1/sqrt(2.*pi))*(1/sqrt(x))*exp(-x/2.)
\begin{center}
	\begin{tabular}{cc}
		\includegraphics[width=6cm,height=4cm]{figures/nos.png} & \includegraphics[width=4cm,height=5cm]{figures/normal-curve.jpg}\\
		P value and significance for $t_\mu$ & \tiny{A Gaussian distribution with significances indicated.}
	\end{tabular}
\end{center}
\end{frame}
}
...
\begin{center}
	\begin{figure}
		\includegraphics[scale=0.5]{figures/lumi-table.png}
		\caption*{Graph of luminosity of LHC measured and expected through years\cite{6}}
	\end{figure}
\end{center}
\end{frame}
\nologo{
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=5.5cm,height=3cm]{figures/35.9fb/kin.png} &
			\includegraphics[width=5.5cm,height=3cm]{figures/150fb/kin.png}\\ 
			\scriptsize{35.9 fb$^{-1}$} & \scriptsize{150 fb$^{-1}$} \\
			\includegraphics[width=5.5cm,height=3cm]{figures/300fb/kin-300.png}&
			\includegraphics[width=5.5cm,height=3cm]{figures/3000fb/kin-3000.png}\\
...
\nologo{
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=5.5cm,height=3cm]{figures/35.9fb/Likelihood.png} &
...
\nologo{
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=5.5cm,height=3cm]{figures/kt-1/35.9fb/kin.png} &
			\includegraphics[width=5.5cm,height=3cm]{figures/kt-1/150fb/kin.png}\\ 
			\scriptsize{35.9 fb$^{-1}$} & \scriptsize{150 fb$^{-1}$} \\
			\includegraphics[width=5.5cm,height=3cm]{figures/kt-1/300fb/kin-300.png}&
			\includegraphics[width=5.5cm,height=3cm]{figures/kt-1/3000fb/kin-3000.png}\\
			\scriptsize{300 fb$^{-1}$} & \scriptsize{3000 fb$^{-1}$} \\
		\end{tabular}
	\end{center}
\end{frame}
...
\end{table}
%upper limit 35.9 asimov 22.328
%mu asimov 35.9 1.0000e+00 +/-  8.32e+00
%mu kt-1 asimov 1.0000e+00 +/-  2.49e-01
%mu kt-1 limit  2.777
\end{frame}
...
%	\item With future experiments, We can get more event data, and so increase the probability of detect Higgs boson in the tH channel.
\end{itemize}
\end{frame}
