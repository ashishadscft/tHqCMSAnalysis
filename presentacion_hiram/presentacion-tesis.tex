...
\tiny{
	\begin{enumerate}
		...
		\item 	Number of jets with high $p_t$ and |$\eta$| < 2.4
	...
	\frametitle{Kinematic variables}
		...
		\begin{center}
			\begin{tabular}{cc}
				...
				{Distribution of events with a $\Delta R$ between the lepton pairs (highest and lowest $p_t$)} & {Distribution of events of $\Delta\phi$ between the higher $p_t$ pair of leptons } \\
			\end{tabular}
		\end{center}
	\end{frame}
}
