...
The currently published result uses 36 fb$^{-1}$ of collision data and obtains an upper limit of 2.04 pb while only 0.077 pb are expected in the SM \cite{ref:tH2019}, the limit is 26 times larger than the expected value.
