...
\pagestyle{fancy}
\fancyhf{}
\rhead{Thesis Project Proposal}
\lhead{Ashish Sehrawat}
\rfoot{Page \thepage}
...
\begin{titlepage}
	\centering
        {\scshape\Large THESIS PROJECT PROPOSAL\par}

	\vspace{2cm}
        \begin{adjustwidth}{2cm}{2cm}{
            TITLE:\par
            \large{Study of the Higgs boson production in association with a single top quark in proton collisions at the Large Hadron Collider}\par}
        \end{adjustwidth}
	...
	{\scshape\large Ashish Sehrawat\par}
        {Student\par}

        \vspace{1cm}
        {\underline{\hspace{8cm}}\par}
	{Dr. Jos\'{e} Feliciano Ben\'{i}tez Rubio\par}
        {Director\par}

        \vspace{1cm}
        {Program: Doctorado en Ciencias (F\'{i}sica) \par}
        {Departamento de Investigac\'{i}on en Fis\'{i}ca (DIFUS) \par}
...
\centering
  ...
  \begin{adjustwidth}{2cm}{2cm}{\large Study of the Higgs boson production in association with a single top quark in proton collisions at the Large Hadron Collider\par}
    \vspace{1cm}
    \centering
...
%\centering Ashish Sehrawat
%\newline \newline
%\centering Director: Dr. Jos\'{e} Feliciano Ben\'{i}tez Rubio
%\newline \newline
%Posgrado en Ciencias (Fis\'{i}ca)
%\newline 
%Departamento de Investigac\'{i}on en Fis\'{i}ca (DIFUS)
%\newline 
