...
\end{itemize}
Table \ref{back} shows the decay chains and production cross sections for the backgrounds. Due to small expected event yields, the processes $W^\pm$ $W^\pm$,$tZq$,$t\bar{t}t\bar{t}$, $VVV$, $tZW^+$ and $ZZ$ are grouped as one called Rares in the results below.
...
\begin{table}[ht]
	\centering
	\caption[Event yields for signal and backgrounds after the event selection for a integrated luminosity of 35.9 fb$^{-1}$. The uncertainties of yields include statistical and systematic]{Event yields for signal and backgrounds after the event selection for a integrated luminosity of 35.9 fb$^{-1}$. The uncertainties of yields include statistical and systematic\cite{th1}}
	\begin{tabular}{cc}
		\hline
...
\begin{figure}[ht]
	...
	\end{minipage}
\caption[Distribution of BDT discriminant for signal and background in the case of SM (left) and inverted coupling scenario (right)]{Distribution of BDT discriminant for signal and background in the case of SM (left) and inverted coupling scenario (right) \cite{th1}}
\label{bdt2}
\end{figure}
