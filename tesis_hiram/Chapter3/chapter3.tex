...
\begin{figure}[ht]
	...
	\end{minipage}
\caption[Distribution of BDT discriminant for signal and background in the case of SM (left) and inverted coupling scenario (right)]{Distribution of BDT discriminant for signal and background in the case of SM (Up) and inverted coupling scenario (Down) \cite{th1}}
\label{bdt2}
\end{figure}
