...
set xlabel "x ->" 
set xrange [ 1.00000e-10 : 15.0000 ] noreverse nowriteback
...
b = 2
k = 8
plot k = 1, x==0?1/0:chisq(x, k) title keystr(k),      k = 2, x==0?1/0:chisq(x, k) title keystr(k),      k = 3, chisq(x, k) title keystr(k),      k = 4, chisq(x, k) title keystr(k),      k = 5, chisq(x, k) title keystr(k),      k = 6, chisq(x, k) title keystr(k),      k = 7, chisq(x, k) title keystr(k),      k = 8, chisq(x, k) title keystr(k)
