...
\caption{LHC schedule, including future plans for increase the center of mass energy and luminosity. The periods labeled LS are the maintenance periods %
\cite{cern3}.}
\label{lhc-lumi}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{The Tracker layout distributed in terms of $\eta$.}
	\label{pixel2}
\end{figure}
...
\begin{figure}[!htbp]
	...
	\caption{Total reconstruction efficiency for muons }\label{efi}
\end{figure}
\\
...
\begin{figure}[!htbp]
	...
	\caption{View of the ECAL}\label{ecal}
\end{figure}
...
\begin{figure}[!htbp]
	...
	\caption{View of the CMS HCAL showing the different layers and tower regions. In the endcap, the towers are defined with two longitudinal segments as shown by the colors}\label{hcal}
\end{figure}
