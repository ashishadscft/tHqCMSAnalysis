...
\begin{table}[!htbp]
\caption[Table of particles in SM]{Table of particles in SM, where it shows the masses, charges,spin, lifetime and distance traveled in a lifetime . Stable means no decay, or lifetime almost infinite\cite{pd}. Particles speeds at c=0.998}
