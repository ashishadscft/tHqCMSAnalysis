...
Baryons are fermions made of 3 quarks. Examples of baryons are protons and neutrons. Both particles can interact via strong force. Since quarks and gluons only exist in bound states, it is impossible to observe isolated quarks except the top quark, which decays before it has time to form a
bound state\cite{gross.griff}.
\\
...
\begin{table}[!htbp]
\caption{Table of particles in SM, where it shows the masses, charges,spin, lifetime and distance traveled in a lifetime . Stable means no decay, or lifetime almost infinite\cite{pd}. Particles speeds at c=0.998}
